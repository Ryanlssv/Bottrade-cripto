...
const BUY_PRICE = 63466;
const SELL_PRICE = 63470;
...
async function start(){
     ...
     // Estrategia sob variação do Preço(compra) sob o Preço venda
     console.clear();
     console.log('****** Estrategia sob variação do Preço(compra) sob o Preço venda (SEM MEDIAS) ****** ');
